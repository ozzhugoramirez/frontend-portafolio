                ...
                {categories.map(cat => (
                  <li key={cat.name}>
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs transition-all ${activeFilter === cat.name
                      ...
                      <div className="flex items-center justify-between px-5 py-3 bg-[#1e1f29] border-b border-black/20">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button
                            ...
                            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-mono transition-all border shadow-sm ${copiedId === item.id
